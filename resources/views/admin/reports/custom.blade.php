...
@section('page-title', 'Custom Date Report')
...
<div class="card">
    <div class="card-header bg-success">
        <h3 class="card-title">
            ...
            Custom Date Report - {{ date('d M Y', strtotime($fromDate)) }} to {{ date('d M Y', strtotime($toDate)) }}
        </h3>
        <div class="card-tools">
            <form action="{{ route('admin.reports.custom') }}" method="POST" style="display: inline;">
                @csrf
