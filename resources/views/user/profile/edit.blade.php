            ...
            <form action="{{ route('user.profile.update') }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="college_name" id="college_name" class="form-control @error('college_name') is-invalid @enderror" value="{{ old('college_name', $user->college_name) }}" required>
                        @error('college_name')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
